...
class S_O_L_L_Y(BaseBot):
    ...
    async def on_start(self, session_metadata: SessionMetadata) -> None:
      ...
      self.highrise.tg.create_task(self.highrise.teleport(
          session_metadata.user_id, Position(x=16.5, y=7.25, z=11.5, facing='FrontRight')))
    ...
    async def on_reaction(self, user: User, reaction: Reaction, receiver: User) -> None:
      ...
      if (user_privileges.moderator) or (user.username in ["S_O_L_L_Y"] and user.username not in ["SOLLY_15"]):
          if reaction == "thumbs":
            await self.highrise.teleport(receiver.id, Position(x=16.5, y=0.25, z=10.5, facing='FrontLeft'))
          if reaction == "wave":
            await self.highrise.teleport(receiver.id, Position(x=11.5, y=7.25, z=14.5, facing='FrontLeft'))
          if reaction == "wink":
            await self.highrise.teleport(receiver.id, Position(x=12.5, y=14.25, z=5.5, facing='FrontRight'))
          if reaction == "clap":
            await self.highrise.teleport(receiver.id, Position(x=8.5, y=0.25, z=25.5, facing='FrontRight'))
          if reaction == "heart":
    ...
    async def on_tip(self, sender: User, receiver: User, tip: CurrencyItem | Item) -> None:
      if tip.amount > 99 and receiver.username in ["S_O_L_L_Y","SOLLY_15"]:
          await self.highrise.teleport(sender.id, Position(x=8.5, y=0.25, z=25.5, facing='FrontRight'))
    ...
    # ... (باقي الأوامر هنا)
      ...
      if message.startswith("back") and user.username in ["S_O_L_L_Y"]:
        await self.highrise.walk_to(Position(x=16.5, y=7.25, z=11.5, facing='FrontRight'))
      ...
      if message in ["Dj","dj","!Dj","!dj","رقصني","رقصنى"]:
        try:
          await self.highrise.teleport(f"{user.id}", Position(x=8.5, y=0.25, z=25.5, facing='FrontRight'))
        except:
          print("error 3")
      ...
      if message in ["Up","up","!Up","!up","طلعني","طلعنى","صعدني","صعدنى"]:
        try:
            await self.highrise.teleport(f"{user.id}", Position(x=11.5, y=7.25, z=14.5, facing='FrontLeft'))
        except:
          print("error 3")

      if message in ["Down","down","!Down","!down","نزلني","نزلنى"]:
        try:
            await self.highrise.teleport(f"{user.id}", Position(x=16.5, y=0.25, z=10.5, facing='FrontLeft'))
        except:
          print("error 3")
      ...
      if message in ["أوامر","اوامر","الاوامر","الأوامر"]:
        try:
          ...
          await self.highrise.chat("All + رقم من (1 to 87) 👉 ترقص روم كلها نفس رقصتك .مثال: All 5 .")
          await self.highrise.chat("الرقصات 👉 يجبلك اسم الرقصات.")
          await self.highrise.chat("vip 👉 ينقلك للفي اي بي.")
          await self.highrise.chat("dj 👉 ينقلك للدي جي.")
      ...
      if message in ["Dance","dance","!Dance","!dance","0","رقصنى","رقصني"]:
        try:
            emote_id = random.choice(self.dances)
            await self.highrise.send_emote(emote_id, user.id)
        except Exception as e:
      ...
      #لو عايز انت بس ترقص
      if message in ["Fly","fly","!Fly","!fly","Float","float","!Float","!float","طيرني","طيرنى"]:
        try:
      ...
      if message in ["Sleigh","sleigh","!Sleigh","!sleigh","مشيني"]:
          try:
      ...
      if message in ["Fashionista","fashionista","!Fashionista","!fashionista","مز"]:
            try:
      ...
      if message in ["Pose 8","pose 8","!Pose 8","!pose 8","P8","p8","بطل"]:
            try:
      ...
      if message in ["Icecreamdance","icecreamdance","!Icecreamdance","!icecreamdance","ايس كريم"]:
            try:
      ...
      if message in ["Macarena","macarena","!Macarena","!macarena","مكرونا"]:
            try:
      ...
      if message in ["Pose 7","pose 7","!Pose 7","!pose 7","P7","p7","جامد"]:
            try:
      ...
      if message in ["Tiktokdance 10","tiktokdance 10","!Tiktokdance 10","!tiktokdance 10","T10","t10","شخلعني"]:
            try:
      ...
      if message in ["Superpose","superpose","!Superpose","!superpose","وحش"]:
            try:
      ...
      if message in ["Weirddance","weirddance","!Weirddance","!weirddance","مسطول"]:
            try:
      ...
      if message in ["Tiktokdance 9","tiktokdance 9","!Tiktokdance 9","!tiktokdance 9","T9","t9","سقف"]:
            try:
      ...
      if message in ["Cute","cute","!Cute","!cute","كيوت"]:
            try:
      ...
      if message in ["Wave","wave","!Wave","!wave","فوق"]:
            try:
      ...
      if message in ["Kiss","kiss","!Kiss","!kiss","مواه"]:
            try:
      ...
      if message in ["Laugh","laugh","!Laugh","!laugh","ضحك"]:
            try:
      ...
      if message in ["Sweating","sweating","!Sweating","!sweating","اوف"]:
            try:
      ...
      if message in ["Cutey","cutey","!Cutey","!cutey","قلبي"]:
            try:
      ...
      if message in ["Pose 5","pose 5","!Pose 5","!pose 5","P5","p5","فخم"]:
            try:
      ...
      if message in ["Teleporting","teleporting","!Teleporting","!teleporting","اخفيني"]:
            try:
      ...
      if message in ["Letsgoshopping","letsgoshopping","!Letsgoshopping","!letsgoshopping","بشتري"]:
            try:
      ...
      if message in ["Greedy","greedy","!Greedy","!greedy","حرامي"]:
            try:
      ...
      if message in ["Pose 3","pose 3","!Pose 3","!pose 3","P3","p3","اخشع"]:
            try:
      ...
      if message in ["Pose 1","pose 1","!Pose 1","!pose 1","P1","p1","وجاهه"]:
            try:
      ...
      if message in ["Punkguitar","punkguitar","!Punkguitar","!punkguitar","طرب"]:
            try:
      ...
      if message in ["Singing","singing","!Singing","!singing","هز"]:
            try:
      ...
      if message in ["Casualdance","casualdance","!Casualdance","!casualdance","عقباوي"]:
            try:
      ...
      if message in ["Confusion","confusion","!Confusion","!confusion","بتقول ايه"]:
            try:
      ...
      if message in ["Raisetheroof","raisetheroof","!Raisetheroof","!raisetheroof","هييه"]:
            try:
      ...
      if message in ["Animedance","animedance","!Animedance","!animedance","نططني"]:
            try:
      ...
      if message in ["Swordfight","swordfight","!Swordfight","!swordfight","خود"]:
            try:
      ...
      if message in ["Advancedshy","advancedshy","!Advancedshy","!advancedshy","مكسوف"]:
            try:
      ...
      if message in ["Tiktokdance 4","tiktokdance 4","!Tiktokdance 4","!tiktokdance 4","T4","t4","هز يبط"]:
            try:
      ...
      if message in ["Dontstartnow","dontstartnow","!Dontstartnow","!dontstartnow","هز يوز"]:
            try:
      ...
      if message in ["Model","model","!Model","!model","مودل"]:
            try:
      ...
      if message in ["Charging","charging","!Charging","!charging","عا"]:
            try:
      ...
      if message in ["Snake","snake","!Snake","!snake","مساج"]:
            try:
      ...
      if message in ["Russiandance","russiandance","!Russiandance","!russiandance","دلعني"]:
            try:
      ...
      if message in ["Uwu","uwu","!Uwu","!uwu","بتكسف"]:
            try:
      ...
      if message in ["Flirtywave","flirtywave","!Flirtywave","!flirtywave","ماشي"]:
            try:
      ...
      if message in ["Cursing","cursing","!Cursing","!cursing","عصبني"]:
            try:
      ...
      if message in ["Wrong","wrong","!Wrong","!wrong","شوف دي"]:
            try:
      ...
      if message in ["Tummyache","tummyache","!Tummyache","!tummyache","بطني"]:
            try:
      ...
      if message in ["Savagedance","savagedance","!Savagedance","!savagedance","عبيط"]:
            try:
      ...
      if message in ["Kpopdance","kpopdance","!Kpopdance","!kpopdance","وسع"]:
            try:
      ...
      if message in ["Pennysdance","pennysdance","!Pennysdance","!pennysdance","اجري"]:
            try:
      ...
      if message in ["Bow","bow","!Bow","!bow","اتفضل"]:
            try:
      ...
      if message in ["Curtsy","curtsy","!Curtsy","!curtsy","شكرا"]:
            try:
      ...
      if message in ["Snowballfight","snowballfight","!Snowballfight","!snowballfight","اتفو"]:
            try:
      ...
      if message in ["Snowangel","snowangel","!Snowangel","!snowangel","بموت"]:
            try:
      ...
      if message in ["Telekinesis","telekinesis","!Telekinesis","!telekinesis","سحر"]:
            try:
      ...
      if message in ["Maniac","maniac","!Maniac","!maniac","جنني"]:
            try:
      ...
      if message in ["Energyball","energyball","!Energyball","!energyball","تمام"]:
            try:
      ...
      if message in ["Frog","frog","!Frog","!frog","بخ"]:
            try:
      ...
      if message in ["Sit","sit","!Sit","!sit","قعدني"]:
            try:
      ...
      if message in ["Hyped","hyped","!Hyped","!hyped","مش شايف"]:
            try:
      ...
      if message in ["Jinglebell","jinglebell","!Jinglebell","!jinglebell","عالم"]:
            try:
      ...
      if message in ["Nervous","nervous","!Nervous","!nervous","يفضحتي"]:
            try:
      ...
      if message in ["Toilet","toilet","!Toilet","!toilet","مزنوق"]:
            try:
      ...
      if message in ["Astronaut","astronaut","!Astronaut","!astronaut","اشطا"]:
            try:
      ...
      if message in ["Timejump","timejump","!Timejump","!timejump","باي"]:
            try:
      ...
      if message in ["Penguindance","penguindance","!Penguindance","!penguindance","سيو"]:
            try:
      ...
      if message in ["Creepypuppet","creepypuppet","!Creepypuppet","!creepypuppet","عفريت"]:
            try:
      ...
      if message in ["Gravity","gravity","!Gravity","!gravity","مرجحني"]:
            try:
      ...
      if message in ["Zombierun","zombierun","!Zombierun","!zombierun","زومبي"]:
            try:
      ...
      if message in ["Enthused","enthused","!Enthused","!enthused","في ايه","سولي","مستفز"]:
          try:
      ...
      if message in ["Kawaii","kawaii","!Kawaii","!kawaii","هاي"]:
           try:
      ...
      if message in ["Repose","repose","!Repose","!repose","نيمني"]:
           try:
      ...
      if message in ["Flex","flex","!Flex","!flex","اه"]:
           try:
      ...
      if message.lstrip().startswith("!tele"):
        ...
        if (user_privileges.moderator) or (user.username in ["S_O_L_L_Y"]):
          ...
          destinations = {
              'vip': Position(x=12.5, y=14.25, z=5.5, facing='FrontRight'),
              'dj': Position(x=8.5, y=0.25, z=25.5, facing='FrontRight'),
              'up': Position(x=11.5, y=7.25, z=14.5, facing='FrontLeft'),
              'down': Position(x=16.5, y=0.25, z=10.5, facing='FrontLeft'),
              'start' : Position(x=16.5, y=7.25, z=11.5, facing='FrontRight'),
          }
